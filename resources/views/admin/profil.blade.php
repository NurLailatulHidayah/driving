            ...
            <div class="card">
                <div class="card-body">
                    <div class="text-center mb-4">
                        <img src="../assets/images/woman.png" class="rounded-circle" alt="Profil" style="width: 200px; height: 200px;">
                    </div>
                    <h6 class="card-title">Informasi Pribadi</h6>
                    <p class="text-muted pb-2">Mengelola informasi pribadi Anda.</p>
                    <form class="forms-sample" action="#" method="POST" id="form-informasi-pribadi">
                        @csrf
                        <div class="mb-3">
        ...
        <div class="col-md-4 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('ubah.informasi.akun.admin') }}" method="POST" id="form-informasi-akun">
                        @csrf
                        <div class="mb-3">
                ...
                <div class="card-body">
                    ...
                    <form class="forms-sample" action="{{ route('ubah.kata.sandi.admin') }}" method="POST" id="form-password">
                        @csrf
                        <div class="mb-3">
...
<script>
    ...
    $('#btn-informasi-pribadi').click(function(event) {
        ...
        $.ajax({
            type: 'POST',
            url: '/ubah-informasi-pribadi-admin',
            data: formData,
